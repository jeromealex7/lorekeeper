...
class EncounterInspector(QtWidgets.QMainWindow):
    ...
    def __init__(self, encounter: Encounter, parent: QtWidgets.QWidget | None = None):
        ...
        self.delete_action.triggered.connect(lambda: self.on_delete())
        ...
        self.copy_action.triggered.connect(lambda: self.on_copy())
        ...
        self.damage_action.triggered.connect(lambda: self.on_damage())
        self.roll_action = QtWidgets.QAction(Icon('dice'), 'Reroll', self)
        self.roll_action.triggered.connect(lambda: self.on_reroll())
        self.inspect_action = QtWidgets.QAction(Icon('helmet'), 'Inspect Guard', self)
        self.inspect_action.triggered.connect(lambda: self.on_inspect_guard())
        self.stats_action = QtWidgets.QAction(Icon('note_text'), 'Show Stats', self)
        self.stats_action.triggered.connect(lambda: self.on_stats_guard())
        self.popup_action = QtWidgets.QAction(Icon('photo_portrait'), 'Show Portrait', self)
        self.popup_action.triggered.connect(lambda: self.on_popup_guard())
        ...
        delete_action.triggered.connect(lambda: self.delete_encounter())
        ...
        reload_action.triggered.connect(lambda: self.load_encounter())
        ...
        SIGNALS.GUARD_COMMIT.connect(lambda _: self.on_selection_change())
        SIGNALS.GUARD_DELETE.connect(lambda _: self.on_selection_change())
